...
const PlaceOrder = () => {
  ...
  const placeOrder = async (e) => {
    ...
    if (payment === "stripe") {
      toast.error(
        "Stripe Payments are yet to be Integrated.\nPlease try using Cash on Delivery for now"
      );
      ...
      // }
      // else {
      //     toast.error("Stripe Payments are yet to be Integrated");
      //     toast.error("Please try using Cash on Delivery for now");
      // }
    } else {
